...
async def admin_set_model(request: Request, payload: ModelOverridePayload, admin_key: str = Depends(verify_admin)):
    ...
    return {
        ...
        "note": "This only updates the running instance. For persistence across Vercel cold starts, set HACKCLUB_AI_MODEL in Vercel's Environment Variables directly."
    }